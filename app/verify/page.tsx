...
export default function VerifyPage() {
  ...
  const handleContinue = () => {
    // Redirect to create page after successful verification
    router.push("/create")
  }
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold mt-4 mb-2 text-gray-900">Verify Your Identity</h1>
          ...
          {!isVerified ? (
            ...
            <div className="text-center">
              <div
                className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center bg-blue-600"
              >
                <span className="text-2xl text-white">✓</span>
              </div>
              <h2 className="text-xl font-bold mb-2 text-gray-900">Verification Complete!</h2>
              <p className="text-gray-600 mb-6">Welcome to TipCelo. You're now verified as a real human.</p>
